...
const Sidebar = () => {
  ...
  if (isCollapsed) {
    return (
      <aside className="w-20 h-[calc(100vh - 56px)] overflow-y-auto sticky top-14 max-sm:hidden flex flex-col sidebar-scroll" style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 56px)' }}>
        <div className="py-3">
  ...
  return (
    <>
      ...
      <aside className="w-60 h-[calc(100vh - 56px)] max-h-screen overflow-y-auto fixed top-14 z-20 bg-black flex flex-col sidebar-scroll" style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 56px)' }}>
        <div className="py-3">
